...
\begin{axis}[
colorbar,
colorbar style={ytick={0,2.5,5,7.5,10,12.5,15,17.5,20},yticklabels={0.0,2.5,5.0,7.5,10.0,12.5,15.0,17.5,20.0},ylabel={}},
colormap={mymap}{[1pt]
...
\addplot graphics [includegraphics cmd=\pgfimage,xmin=0, xmax=8, ymin=8.5, ymax=-0.5] {Decision_Tree_Model_confusion_matrix-000.png};
